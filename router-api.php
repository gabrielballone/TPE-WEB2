...
$router->addRoute('comentarios/:ID', 'GET', 'ApiCommentController', 'getAllByIdCourse');
$router->addRoute('comentarios/usuario/:ID', 'GET', 'ApiCommentController', 'getAllByIdUser');
